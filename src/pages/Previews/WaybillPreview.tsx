        ...
        <div className="containerWaybill">
          ...
          <div className="title">
            ...
            <div className="flex" style={{ gap: "1rem" }}>
              ...
              {/* @ts-ignore */}
              <p>К путевому листу № {docData.waybillDoc.waybillNo}</p>
            </div>
            <div className="flex" style={{ gap: "1rem" }}>
              <p>
                {/* @ts-ignore */}
                {moment(docData.waybillDoc.waybillDate.$d).format("YYYY-MM-DD")}
              </p>
              <p>
                {/* @ts-ignore */}
            ...
            <div className="flex" style={{ justifyContent: "space-between" }}>
              ...
              <div className="flex gap-1">
                ...
                <div>
                  ...
                  {/* @ts-ignore */}
                  <p>{docData.pointDocs[0].pointOfUnloading}</p>
                  {/* @ts-ignore */}
                  <p>{docData.pointDocs[1].pointOfUnloading}</p>
                  {/* @ts-ignore */}
          ...
          <div className="flex" style={{ justifyContent: "space-between" }}>
            ...
            <div>
              ...
              >
                ...
                {/* @ts-ignore */}
                {docData.deliveryDistanceDoc.deliveryDistanceInCity}
              </div>
            </div>
          </div>
        </div>
