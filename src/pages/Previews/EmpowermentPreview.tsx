...
const EmpowermentPreview = () => {
    ...
    const qrCodeValue = `https://my3.soliq.uz/roaming-viewer/ru/document?id=${params.id}&filetype=2&tin=${location?.state}`;
    return (
        <div>
            {/* @ts-ignore */}
            <Header
            ...
            <div style={{ padding: '20px' }}>
                ...
                {/* @ts-ignore */}
                <div className="containerEmp" style={{ paddingTop: '0px' }}>
                    <div
                        style={{
                            width: '100%',
                            height: '150px',
                    ...
                    <div className="info-block">
                        ...
                        <div className="row">
                            <p className="bold">
                                ...
                                {moment(docData.agent.dateOfIssue).format(
                                    'YYYY-MM-DD'
                                )}
                            </p>
                            <p></p>
                        ...
                        <div className="row">
                            <p className="bold">
                                Материальных ценностей по договору:{' '}
                            </p>
                            <p>
                                {/* @ts-ignore */}
                                {/* @ts-ignore */}№{' '}
                                {docData.contractDoc.contractNo} от{' '}
                                {/* @ts-ignore */}
                                {moment(
