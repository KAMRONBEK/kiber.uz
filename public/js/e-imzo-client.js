...
var EIMZOClient = {
  ...
  listAllUserKeys: function (itemIdGen, itemUiGen, success, fail) {
    ...
    if (!EIMZOClient.NEW_API) {
      EIMZOClient._findCertKeys(
        itemIdGen,
        itemUiGen,
        items,
        errors,
        function (firstItmId) {
          EIMZOClient._findPfxs(
            itemIdGen,
            itemUiGen,
            items,
            errors,
  ...
  appendPkcs7Attached: function (id, data, timestamper, success, fail) {
    CAPIWS.callFunction(
      { plugin: "pkcs7", name: "append_pkcs7_attached", arguments: [data, id] },
      function (event, data) {
        if (data.success) {
          var pkcs7 = data.pkcs7_64
          if (timestamper) {
  ...
  _findCertKeyCertificates: function (
    itemIdGen,
    itemUiGen,
    items,
    errors,
